 ...
 * @version Spring 2020
 */
public class OrigRandomSensorDataGenerator {
	 ...
	 */
	public static int 		intervals = 5000;   /// Interval is how many data point the Program prints to lists and represents minutes. 2400 hrs = 1 day of data.
